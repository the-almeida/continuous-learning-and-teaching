...
Automated LinkedIn connection workflows using Python and Selenium. This repository includes a CLI scaffold, Selenium browser factory, config management, logging utilities, and a functional LinkedIn client.
...
- Implement the connection flow based on a search link and default message (rate-limited, human-like pacing)
- Add messages customized with connection name
