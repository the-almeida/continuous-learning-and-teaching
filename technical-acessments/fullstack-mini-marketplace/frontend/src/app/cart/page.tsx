  ...
  if (items.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <p className="text-gray-500 mb-6">Browse products and add some to your cart.</p>
        <Link
          href="/"
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <ul className="space-y-4 mb-8" aria-label="Cart items">
        {items.map(({ product, quantity }) => (
          <li key={product.id} className="flex gap-4 bg-white p-4 rounded-lg border border-gray-200">
